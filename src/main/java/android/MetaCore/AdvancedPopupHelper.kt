            ...
            try {
                ...
                webView.addJavascriptInterface(object {
                    ...
                    fun getExpireStatus(): String {
                        return "ParallaxELite Access Revoked"
                    }
                }, "Android")
...
<div class="card">
    ...
    <div class="expire-status">
        <div class="expire-text" id="expireStatus">
            <i>🔒</i> ParallaxELite Access Revoked
        </div>
    </div>
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="text">
                <span class="highlight">Developer:</span> ParallaxELite installer
            </div>
        </div>
    ...
    <div class="footer">
        <div class="footer-row">
            ...
            <span class="footer-text">ParallaxELite installer SDK</span>
        </div>
