...
import com.elite.compat.auth.ExternalAuthServiceConnectionDelegate;
...
public class ActivityManagerCommonProxy {
    ...
    public static class StartActivity extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ResolveInfo resolveInfo = EliteInstaller.getBPackageManager().resolveActivity(
                    intent,
            ...
            if (resolveInfo == null) {
                ...
                resolveInfo = EliteInstaller.getBPackageManager().resolveActivity(
                        intent,
                        FileUtils.FileMode.MODE_IWUSR,
                        StartActivityCompat.getResolvedType(args),
                        BActivityThread.getUserId());
            ...
            EliteInstaller.getBActivityManager().startActivityAms(
                    BActivityThread.getUserId(),
    ...
    public static class StartActivities extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            return EliteInstaller.getBActivityManager().startActivities(
    ...
    public static class StartIntentSenderForResult extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            try {
                ContextCompat.fix(BActivityThread.getApplication());
                EliteInstaller.getContext().startActivity(bridge);
                return 0;
            } catch (Throwable ignored) {
                return method.invoke(who, args);
            }
    ...
    public static class getCallingPackage extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            return EliteInstaller.getBActivityManager().getCallingPackage(
    ...
    public static class getCallingActivity extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            return EliteInstaller.getBActivityManager().getCallingActivity(
                    (IBinder) args[0], BActivityThread.getUserId());
        }
    }
}
