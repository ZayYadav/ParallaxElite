...
import com.parallaxelite.utils.DrawableUtils;
...
public class TaskDescriptionCompat {
    public static ActivityManager.TaskDescription fix(ActivityManager.TaskDescription td) {
        ...
        ActivityManager am = (ActivityManager) ParallaxELiteInstaller.getContext().getSystemService(Context.ACTIVITY_SERVICE);
