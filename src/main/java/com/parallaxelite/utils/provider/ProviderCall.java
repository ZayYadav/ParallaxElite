package com.parallaxelite.utils.provider;
...
import com.parallaxelite.utils.compat.ContentProviderCompat;
...
public class ProviderCall {
    ...
    public static Bundle callSafely(String authority, String methodName, String arg, Bundle bundle) {
        try {
            Bundle result = call(authority, ParallaxELiteInstaller.getContext(), methodName, arg, bundle, 5);
