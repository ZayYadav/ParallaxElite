...
import com.parallaxelite.app.RequestPermissionsActivity;
...
public class PermissionUtils {
    ...
    public static boolean isCheckPermissionRequired(ApplicationInfo info) {
        if (info == null || ParallaxELiteInstaller.getContext() == null) {
            return false;
        }
        ...
        ApplicationInfo hostInfo = ParallaxELiteInstaller.getContext().getApplicationInfo();
    ...
    public static boolean checkPermissions(String[] permissions) {
        ...
        for (String permission : permissions) {
            if (!ParallaxELiteInstaller.get().checkSelfPermission(permission)) {
                return false;
            }
        }
        return true;
