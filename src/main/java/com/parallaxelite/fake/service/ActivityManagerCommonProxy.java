...
import com.parallaxelite.fake.provider.FileProviderHandler;
...
import com.parallaxelite.utils.compat.StartActivityCompat;
...
public class ActivityManagerCommonProxy {
    ...
    public static class StartActivity extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (ComponentUtils.isRequestInstall(intent)) {
                ...
                if (ParallaxELiteInstaller.get().requestInstallPackage(file)) {
            ...
            ResolveInfo resolveInfo = ParallaxELiteInstaller.getBPackageManager().resolveActivity(
                    intent,
            ...
            if (resolveInfo == null) {
                ...
                resolveInfo = ParallaxELiteInstaller.getBPackageManager().resolveActivity(
                        intent,
                        FileUtils.FileMode.MODE_IWUSR,
                        StartActivityCompat.getResolvedType(args),
                        BActivityThread.getUserId());
            ...
            ParallaxELiteInstaller.getBActivityManager().startActivityAms(
                    BActivityThread.getUserId(),
    ...
    public static class StartActivities extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            return ParallaxELiteInstaller.getBActivityManager().startActivities(
    ...
    public static class StartIntentSenderForResult extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            try {
                ContextCompat.fix(BActivityThread.getApplication());
                ParallaxELiteInstaller.getContext().startActivity(bridge);
                return 0;
            } catch (Throwable ignored) {
                return method.invoke(who, args);
            }
    ...
    public static class ActivityResumed extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ParallaxELiteInstaller.getBActivityManager().onActivityResumed((IBinder) args[0]);
            return method.invoke(who, args);
        }
    }
    ...
    public static class ActivityDestroyed extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ParallaxELiteInstaller.getBActivityManager().onActivityDestroyed((IBinder) args[0]);
            return method.invoke(who, args);
        }
    }
    ...
    public static class FinishActivity extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ParallaxELiteInstaller.getBActivityManager().onFinishActivity((IBinder) args[0]);
            return method.invoke(who, args);
        }
    }
    ...
    public static class getCallingPackage extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            return ParallaxELiteInstaller.getBActivityManager().getCallingPackage(
    ...
    public static class getCallingActivity extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            return ParallaxELiteInstaller.getBActivityManager().getCallingActivity(
                    (IBinder) args[0], BActivityThread.getUserId());
        }
    }
}
