...
import com.parallaxelite.fake.delegate.InnerReceiverDelegate;
import com.parallaxelite.fake.delegate.ServiceConnectionDelegate;
...
import com.parallaxelite.fake.hook.ProxyMethods;
import com.parallaxelite.fake.hook.ScanClass;
import com.parallaxelite.fake.service.base.PkgMethodProxy;
import com.parallaxelite.fake.service.context.providers.ContentProviderStub;
import com.parallaxelite.fake.service.context.providers.SystemProviderStub;
import com.parallaxelite.proxy.ProxyManifest;
import com.parallaxelite.proxy.ProxyBroadcastReceiver;
import com.parallaxelite.proxy.ProxyPendingService;
...
import com.parallaxelite.utils.compat.TaskDescriptionCompat;
...
public class IActivityManagerProxy extends ClassInvocationStub {
		...
		protected Object hook(Object who, Method method, Object[] args) throws Exception {
			...
			if (BuildCompat.isQ() || BuildCompat.isR()) {
				if (args.length > 1 && args[1] instanceof String) {
					args[1] = ParallaxELiteInstaller.getHostPkg();
				}
			}
			...
			ProviderInfo providerInfo = ParallaxELiteInstaller.getBPackageManager().resolveContentProvider(authority, FileUtils.FileMode.MODE_IWUSR, BActivityThread.getUserId());
			...
			if (BActivityThread.getAppPid() != -1) {
				...
				AppConfig appConfig = ParallaxELiteInstaller.getBActivityManager().initProcess(providerInfo.packageName, providerInfo.processName, BActivityThread.getUserId());
				...
				if (appConfig.bpid != BActivityThread.getAppPid()) {
					providerBinder = ParallaxELiteInstaller.getBActivityManager().acquireContentProviderClient(providerInfo);
				}
				...
				if (args.length > userIndex) {
					args[userIndex] = ParallaxELiteInstaller.getHostUserId();
				}
			}
    ...
    public static class StartService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            return ParallaxELiteInstaller.getBActivityManager().startService(
    ...
    public static class StopService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            Intent intent = (Intent) args[intentIndex];
            String resolvedType = findStringAfter(args, intentIndex);
            return ParallaxELiteInstaller.getBActivityManager().stopService(
    ...
    public static class StopServiceToken extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ParallaxELiteInstaller.getBActivityManager().stopServiceToken(componentName, token, BActivityThread.getUserId());
            return true;
        }
    }
    ...
    public static class BindService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            Intent bindService = ParallaxELiteInstaller.getBActivityManager().bindService(
                    intent,
        ...
        protected boolean isEnable() {
            return ParallaxELiteInstaller.get().isBlackProcess()
                    || ParallaxELiteInstaller.get().isServerProcess();
        }
    }
    ...
    public static class UnbindService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ParallaxELiteInstaller.getBActivityManager().unbindService(iServiceConnection.asBinder(), BActivityThread.getUserId());
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (result instanceof IInterface) {
                ...
                if (packagesForUid.length < 1) {
                    packagesForUid = new String[]{ParallaxELiteInstaller.getHostPkg()};
                }
                ParallaxELiteInstaller.getBActivityManager().getIntentSender(
                        sender.asBinder(),
                        packagesForUid[0],
    ...
    public static class getPackageForIntentSender extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            return ParallaxELiteInstaller.getBActivityManager().getPackageForIntentSender(invoke.asBinder());
        }
    }
    ...
    public static class getUidForIntentSender extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            IInterface invoke = (IInterface) args[0];
            return ParallaxELiteInstaller.getBActivityManager().getUidForIntentSender(invoke.asBinder());
        }
    }
    ...
    public static class BroadcastIntent extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            Intent proxyIntent = ParallaxELiteInstaller.getBActivityManager().sendBroadcast(intent, resolvedType, BActivityThread.getUserId());
            if (proxyIntent != null) {
    ...
    public static class PeekService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            return ParallaxELiteInstaller.getBActivityManager().peekService(intent, resolvedType, BActivityThread.getUserId());
        }
    }
        ...
        private static void normalizeReceiverUserAndFlags(
            ...
            if (intCount >= 2) {
                ...
                if (args[userIdIndex] instanceof Integer) {
                    args[userIdIndex] = ParallaxELiteInstaller.getHostUserId();
                }
    ...
    public static class getCurrentUser extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            return BRUserInfo.get()._new(BActivityThread.getUserId(), "ParallaxELiteCore", BRUserInfo.get().FLAG_PRIMARY());
        }
    }
    ...
    public static class checkPermission extends MethodHook {
        ...
        private static void replacePermissionCheckUid(Object[] args) {
            ...
            if (uid == BActivityThread.getBUid()) {
                args[2] = ParallaxELiteInstaller.getHostUid();
            }
        }
    }
